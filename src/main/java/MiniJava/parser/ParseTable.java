...
//                        try {
                        ...
                        Action a = cols[j].charAt(0) == 'r' ? new ReduceAction(Integer.parseInt(cols[j].substring(1))): new ShiftAction(Integer.parseInt(cols[j].substring(1)));                        actionTable.get(actionTable.size() - 1).put(t, a);
